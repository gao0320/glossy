...
<div class="layout-aside">
    <div class="title">
     ...
     <!-- :router="true" 全写  开启路由模式 -->
    <el-menu :collapse="collapse" router :style="{width: collapse ? '60px' : '230px'}" background-color="#353b4e" text-color="#adafb5" active-text-color="#ffd04b">
    <el-menu-item index="/">
...
<el-submenu index="2">
    <template slot="title">
        ...
        <el-menu-item index="/home/fansinfo">粉丝面向</el-menu-item>
